...
def training(
    ...
    for iteration in range(first_iter, opt.iterations + 1):
        ...
        with torch.no_grad():
            ...
            # Log and save - always save at final iteration
            ...
            # Always save checkpoint at final iteration
            if iteration in checkpoint_iterations or iteration >= opt.iterations - 1:
