...
from diff_gaussian_rasterization_mmfr_pcheck_obb import (
...
def render(
    ...
    screenspace_points = (
        torch.zeros_like(
            multi_gs[0].get_xyz,
            dtype=multi_gs[0].get_xyz.dtype,
            requires_grad=True,
            device="cuda",
        )
        + 0
    ...
    all_rendered_image = (
        rendered_image0 + rendered_image1 + rendered_image2 + rendered_image3
    )
