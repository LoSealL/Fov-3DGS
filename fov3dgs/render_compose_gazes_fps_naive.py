...
from gaussian_renderer_fov_naive import GaussianModel, render
from scene import Scene
from utils.general_utils import safe_state


def render_set(
    out_path, name, iteration, views, gaussians, pipeline, background, highest_levels
):
...
def render_sets(
    ...
    with torch.no_grad():
        ...
        mask_path = os.path.join(
            args.base_folder,
            f"all_shared_fr_{args.layer_num}_{args.max_pooling_size}",
            "highest_levels.pth",
        )
        ...
        out_path = os.path.join(
            args.base_folder, f"all_shared_fr_{args.layer_num}_{args.max_pooling_size}"
        )
