...
method = "naiveFR"
iterations_list = [55000, 55000, 55000, 55000]
...
def main():
    for scene in all_scenes:
        ...
        for i in range(len(method_dir_list)):
            ...
            render_command = f"python render_naive.py -s {scene_dir} -m {method_path} --eval --skip_train --iteration {iterations} --target_layer {i} -hl {hl} --out_folder {of}"
