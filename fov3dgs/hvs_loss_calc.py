...
from odak.learn.perception import MetamericLoss, MetamericLossUniform
...
class HVSLoss:
    def __init__(
        ...
        device="cuda",
        loss_type="MSE",
        bilinear_downsampling=True,
        alpha=0.05,
        real_image_width=1.0,
        real_viewing_distance=0.5,
        uniform_pooling_size=1,
    ):
        ...
        self.uniform_loss = MetamericLossUniform(
            n_pyramid_levels=self.n_pyramid_levels,
            n_orientations=self.n_orientations,
            pooling_size=uniform_pooling_size,
            device=self.device,
        )
